...
<img style="width: 20%;" src="../../images/bg.png" alt="Logo"><br>
            ...
            <td style="width: 50%; color: #34495e;font-size:16px;text-align:center">
                ...
                <?= DIRECCION_EMPRESA ?><br>Teléfono: <?= TELEFONO_EMPRESA ?><br>Email: <?= EMAIL_EMPRESA ?>
            </td>
            <td style="width: 25%;text-align:right;font-size:16px;">FACTURA Nº <?= $numero ?>
            </td>
        </tr>
    </table><br>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt; font-family:freeserif;">
        ...
        foreach ($arrDetalles as $fila) {
            ...
            $precio_unitario_f = number_format($precio_unitario, 0); //Formateo variables
            $precio_unitario_r = str_replace(",", "", $precio_unitario_f); //Reemplazo las comas
            ...
            <tr>
                <td class='<?= $clase ?>' style="width: 10%; text-align: center"><?= $cantidad; ?>
                </td>
                <td class='<?= $clase ?>' style="width: 60%; text-align: left"><?= $concepto; ?>
                </td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 12pt; font-family:freeserif;">
        <tr>
            ...
            <td style="width: 15%; text-align: right;"> <?= number_format($subtotal, 0) ?>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="width: 85%; text-align: right;">IVA 10% </td>
            <td style="width: 15%; text-align: right;"> <?= number_format($total_iva, 0) ?>
            </td>
        </tr>
        <tr>
